...
<section class="category-section">
    <div class="container">
        ...
        <div class="category-grid">
            ...
            @foreach($categoriesInformatique as $categorie)
               <a href="/categorie/{{ $categorie['id'] }}"> <div class="category-card">
                    ...
                    <div class="category-content">
                        <div>
                            ...
                            <p class="category-desc">Découvrez nos produits pour {{ strtolower($categorie['title']) }}.</p>
                        </div>
                        <div class="category-footer">
                            <span class="category-count"><i class="fas fa-box"></i> Plusieurs articles</span>
                        </div>
                    </div>
                </div></a>
            @endforeach
...
<div class="item " style="margin:10px;width:50%">
                ...
                <h6>Ordinateurs portables

                <br><span>Commander tous les Ordinateurs portables disponibles</span></h6>
                </div> </div></div>
...
<div class="item " style="margin:10px;width:50%">
                <img src="computer.png" alt="" style="max-width: 52px;">
                <h6>Accessoires PC
                <br><span>Commander tous les Accessoires PC
                disponibles</span></h6>
                </div> </div></div>
...
<div class="item " style="margin:10px;width:50%">
                <img src="computer.png" alt="" style="max-width: 52px;">
                <h6>Composants PC
                <br><span>Commander tous les Composants PC
                disponibles</span></h6>
                </div> </div></div>
...
<div class="item " style="margin:10px;width:50%">
                <img src="arrow.png" alt="" style="max-width: 52px;">
                <h6>Périphériques
                <br><span>Commander tous les Périphériques
                disponibles</span></h6>
                </div> </div></div>
...
<div class="item " style="margin:10px;width:50%">
                <img src="circle (2).png" alt="" style="max-width: 52px;">
                <h6>Réseaux & Internet
                <br><span>Commander tous les Réseaux & Internet
                disponibles</span></h6>
                </div> </div></div>
...
<div class="item " style="margin:10px;width:50%">
                <img src="interaction.png" alt="" style="max-width: 52px;">
                <h6>Stockage
                <br><span>Commander tous les Stockage
                disponibles</span></h6>
                </div> </div></div>
...
<div class="item " style="margin:10px;width:50%">
                <img src="computer (1).png" alt="" style="max-width: 52px;">
                <h6>Support & câblage
                <br><span>Commander tous les Support & câblage
                disponibles</span></h6>
                </div> </div></div>
...
<div class="item " style="margin:10px;width:50%">
                <img src="playstation.png" alt="" style="max-width: 52px;">
                <h6>Gaming
                <br><span>Commander tous se concerne Gaming
                </span></h6>
                </div> </div></div>
...
<div class="item " style="margin:10px;width:50%">
                <img src="laptop.png" alt="" style="max-width: 52px;">
                <h6>Ordinateurs portables
                <br><span>Commander tous les Ordinateurs portables
                disponibles</span></h6>
                </div> </div></div>
