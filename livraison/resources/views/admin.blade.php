                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Total">{{$commande->numero}}</td>
                            <td data-label="Adresse">{{$commande->address}}</td>
                            <td><a href="/confirmer/{{$commande->id}}"><button class="btn">Confirmer</button></a> 
                            <a href="/suprimercommande/{{$commande->id}}"><button class="btn">suprimer</button></a></td>
                        </tr>
                        @endif
                        @endforeach
